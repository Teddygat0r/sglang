...
from test_mamba_compression_snapshot import make_tree
...
def cache():
    ...
    t.req_to_token_pool.mamba_pool.mamba_cache.conv = [torch.full((2, 3, 3, 4), 99.0)]
...
class CompressionJobTests(unittest.TestCase):
    def test_tombstone_upgrade_rejects_old_result_and_accepts_new(self):
        ...
        t._compression_done_queue.put((old, torch.full((2, 2, 34), 7.0)))
        ...
        t._compression_done_queue.put((new, torch.full((2, 2, 34), 11.0)))
        t.drain_compression_completions()
